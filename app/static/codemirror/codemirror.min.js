!(function (e, t) {
  ...
  var e = navigator.userAgent,
    ...
    u = /Edge\/(\d+)/.exec(e),
    w = t || a || u,
    v = w && (t ? document.documentMode || 6 : +(u || a)[1]),
    x = !u && /WebKit\//.test(e),
    t = x && /Qt\/\d+\.\d+/.test(e),
    U = !u && /Chrome\/(\d+)/.exec(e),
    V = U && +U[1],
    ...
    X = /PhantomJS/.test(e),
    d = j && (/Mobile\/\w+/.test(e) || 2 < navigator.maxTouchPoints),
    Y = /Android/.test(e),
    $ = d || Y || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(e),
    C = d || /Mac/.test(s),
    _ = /\bCrOS\b/.test(e),
    a = /win/i.test(s),
  ...
  var Qe,
    Je,
    et = !(w && v < 9) && ("draggable" in (s = M("div")) || "dragDrop" in s);
  var tt =
      3 != "\n\nb".split(/\n/).length
        ? function (e) {
  ...
  var ut = {};
  function ct(e, t) {
    ce(t, ut.hasOwnProperty(e) ? ut[e] : (ut[e] = {}));
  }
  function ht(e, t) {
    if (!0 === t) return t;
  ...
  function W(e) {
    ...
    for (
      var t = e.parent, n = S(t.lines, e), r = t.parent;
      r;
      r = (t = r).parent
    )
  ...
  function H(e, t, n) {
    if ((void 0 === n && (n = null), !(this instanceof H)))
      return new H(e, t, n);
  ...
  function P(e, t) {
    var n;
    return t.line < e.first
      ? H(e.first, 0)
      : ((n = e.first + e.size - 1),
        t.line > n
          ? H(n, D(e, n).text.length)
          : ((e = D(e, (n = t).line).text.length),
            null == (t = n.ch) || e < t
              ? H(n.line, e)
              : t < 0
              ? H(n.line, 0)
  ...
  (g.prototype.eol = function () {
    ...
    (g.prototype.match = function (e, t, n) {
      ...
      return "string" != typeof e
        ? (r = this.string.slice(this.pos).match(e)) && 0 < r.index
          ? null
          : (r && !1 !== t && (this.pos += r[0].length), r)
        : (r = function (e) {
            return n ? e.toLowerCase() : e;
          })(this.string.substr(this.pos, e.length)) == r(e)
          ...
          (t = (function (e, t, n) {
            for (
              ...
              if (
                ...
                return s;
              u = he(a.text, null, e.options.tabSize);
              (null == i || u < r) && ((i = s - 1), (r = u));
            }
            return i;
          })(n, r, e)) > l.first && D(l, t - 1).stateAfter),
        (o = i ? Mt.fromSaved(l, i, t) : new Mt(l, ft(l.mode), t)),
        l.iter(t, r, function (e) {
          Dt(n, e.text, o);
          var t = o.line;
          (e.stateAfter =
            t == r - 1 || t % 5 == 0 || (t >= s.viewFrom && t < s.viewTo)
              ? o.save()
              : null),
            o.nextLine();
        }),
        e && (l.modeFrontier = o.line),
        o)
      : new Mt(l, !0, r);
  }
  function Dt(e, t, n, r) {
  ...
  function Wt(e, t) {
    return e.blankLine
      ? e.blankLine(t)
      : e.innerMode && (e = dt(e, t)).mode.blankLine
      ? e.mode.blankLine(e.state)
      : void 0;
  }
  function Ht(e, t, n, r) {
    for (var i = 0; i < 10; i++) {
  ...
  function Ut(e, t) {
    ...
    var n = yt(e, t.from.line) && D(e, t.from.line).markedSpans,
      e = yt(e, t.to.line) && D(e, t.to.line).markedSpans;
    if (!n && !e) return null;
    var r = t.from.ch,
      i = t.to.ch,
      o = 0 == F(t.from, t.to),
  ...
  function $t(e, t) {
    var n,
      r,
      i = e.lines.length - t.lines.length;
    return 0 != i
      ? i
      : ((i = e.find()),
        (n = t.find()),
        (r = F(i.from, n.from) || Xt(e) - Xt(t))
          ? -r
          : F(i.to, n.to) || Yt(e) - Yt(t) || t.id - e.id);
  }
  function _t(e, t) {
    var n,
      r = Rt && e.markedSpans;
      ...
      for (var l = 0; l < o.length; ++l) {
        ...
        if (s.marker.collapsed) {
          var a = s.marker.find(0),
            u = F(a.from, n) || Xt(s.marker) - Xt(i),
            c = F(a.to, r) || Yt(s.marker) - Yt(i);
          if (
            !((0 <= u && c <= 0) || (u <= 0 && 0 <= c)) &&
            ((u <= 0 &&
  ...
  function cn(e, t) {
    return !e || /^\s*$/.test(e)
      ? null
      : (t = t.addModeClass ? un : an)[e] ||
          (t[e] = e.replace(/\S+/g, "cm-$&"));
  }
  function hn(e, t) {
    var n = te("span", null, null, x ? "padding-right: .1px" : null),
      r = {
    ...
    t.measure = {};
    for (var i, o, l = 0; l <= (t.rest ? t.rest.length : 0); l++) {
      var s = l ? t.rest[l - 1] : t.line,
        a = void 0,
        u =
          ((r.pos = 0),
          (r.addToken = fn),
          ...
          (null != Je
            ? Je
            : ((o = y(u, document.createTextNode("AخA"))),
              (i = oe(o, 0, 1).getBoundingClientRect()),
              (o = oe(o, 1, 2).getBoundingClientRect()),
              ee(u),
              i && i.left != i.right && (Je = o.right - i.right < 3))) &&
            (a = Ge(s, e.doc.direction)) &&
          ...
          (r.map = []),
          t != e.display.externalMeasured && W(s));
      !(function (e, t, n) {
        var r = e.markedSpans,
          i = e.text,
          o = 0;
        ...
        s.styleClasses &&
          (s.styleClasses.bgClass &&
            (r.bgClass = ie(s.styleClasses.bgClass, r.bgClass || "")),
          s.styleClasses.textClass) &&
          (r.textClass = ie(s.styleClasses.textClass, r.textClass || "")),
        0 == r.map.length &&
          r.map.push(
            0,
            0,
            r.content.appendChild(
              ...
              (o = (Qe =
                null == Qe &&
                ((i = M("span", "​")),
                y(o, M("span", [i, document.createTextNode("x")])),
                0 != o.firstChild.offsetHeight)
                  ? i.offsetWidth <= 1 && 2 < i.offsetHeight && !(w && v < 8)
                  : Qe)
                ? M("span", "​")
                : M(
                    "span",
    ...
    return (
      ...
      r.pre.className && (r.textClass = ie(r.pre.className, r.textClass || "")),
      r
    );
  }
  function dn(e) {
  ...
  function gn(e, t, n) {
    (this.line = t),
      ...
      (this.size = this.rest ? W(I(this.rest)) - n + 1 : 1),
      (this.node = this.text = null),
      (this.hidden = nn(e, t));
  }
  function mn(e, t, n) {
    for (var r = [], i = t; i < n; i = l) {
      var o = new gn(e.doc, D(e.doc, i), i),
        l = i + o.size;
      r.push(o);
    }
    return r;
  ...
  function wn(e, t, n, r) {
    for (var i = 0; i < t.changes.length; i++) {
      ...
      if ("text" == o) {
        ...
        for (
          var h = Q("CodeMirror-linewidget"), d = c.node.firstChild, f = void 0;
          d;
          d = f
        )
  ...
  function Dn(e) {
    ...
    return (
      e.cachedPaddingH ||
      ((t = y(e.measure, M("pre", "x", "CodeMirror-line-like"))),
      (t = window.getComputedStyle
        ? window.getComputedStyle(t)
        : t.currentStyle),
      (t = { left: parseInt(t.paddingLeft), right: parseInt(t.paddingRight) }),
      isNaN(t.left) || isNaN(t.right) || (e.cachedPaddingH = t),
      t)
    );
  }
  function Wn(e) {
  ...
  function zn(e, t) {
    return t >= e.display.viewFrom && t < e.display.viewTo
      ? e.display.view[pr(e, t)]
      : (e = e.display.externalMeasured) && t >= e.lineN && t < e.lineN + e.size
      ? e
      : void 0;
  }
  function In(e, t) {
              ...
              (i =
                w && v < 9 && 0 == s && a == o.coverEnd - o.coverStart
                  ...
                  : (function (e, t) {
                      ...
                      return n;
                    })(oe(l, s, a).getClientRects(), r)).left ||
              i.right ||
              0 == s
            )
              break;
            ...
            (i = (function (e, t) {
              ...
              return window.screen &&
                ...
                (function (e) {
                  ...
                  return null != it
                    ? it
                    : ((t = (e = y(e, M("span", "x"))).getBoundingClientRect()),
                      (e = oe(e, 0, 1).getBoundingClientRect()),
                      (it = 1 < Math.abs(t.left - e.left)));
                })(e)
      ...
      : ((r = t.left),
        ...
        "page" == n
          ...
          : ("local" != n && n) ||
            ...
            (t += n.top)),
        {
          left: r - (n = e.display.lineSpace.getBoundingClientRect()).left,
          top: t - n.top,
        });
  }
  function Zn(e, t, n, r, i) {
    return _n(e, (r = r || D(e.doc, t.line)), En(e, r, t.ch, i), n);
  }
  function Qn(n, e, r, i, o, l) {
    ...
    (i = i || D(n.doc, e.line)), (o = o || In(n, i));
    var t,
      a,
      u = Ge(i, n.doc.direction),
      c = e.ch,
      e = e.sticky;
    return (
      c >= i.text.length
        ? ((c = i.text.length), (e = "before"))
        : c <= 0 && ((c = 0), (e = "after")),
      u
        ? ((a = He(u, c, e)),
          (t = We),
          (a = h(c, a, "before" == e)),
          null != t && (a.other = h(c, t, "before" != e)),
          a)
        : s("before" == e ? c - 1 : c, "before" == e)
    );
    function h(e, t, n) {
  ...
  function tr(e, t, n) {
    ...
    var i = vt(r, n),
      o = r.first + r.size - 1;
    if (o < i) return er(r.first + r.size - 1, D(r, o).text.length, null, 1, 1);
    t < 0 && (t = 0);
    for (var l = D(r, i); ; ) {
  ...
  function or(n, r, i, o, l, s, a) {
      ...
      t = De(
        function (e) {
          ...
          return ir(
            Qn(
              n,
              H(i, t ? e.to : e.from, t ? "before" : "after"),
              "line",
              r,
              o
            ),
    ...
    return (u =
      ...
      ir(
        (e = Qn(
          n,
          H(i, e ? u.from : u.to, e ? "after" : "before"),
          "line",
          r,
          o
        )),
  ...
  function sr(e) {
    ...
    return 3 < n && (e.cachedTextHeight = n), ee(e.measure), n || 1;
  }
  function ar(e) {
    var t, n;
    return null != e.cachedCharWidth
      ? e.cachedCharWidth
      : ((n = M("span", "xxxxxxxxxx")),
        (t = M("pre", [n], "CodeMirror-line-like")),
        y(e.measure, t),
        2 < (n = ((t = n.getBoundingClientRect()).right - t.left) / 10) &&
          (e.cachedCharWidth = n),
        n || 10);
  }
  function ur(e) {
  ...
  function fr(e, t, n, r) {
    ...
    return (
      r &&
        0 < i.xRel &&
        (t = D(e.doc, i.line).text).length == i.ch &&
        ((n = he(t, t.length, e.options.tabSize) - t.length),
        (i = H(
          i.line,
  ...
  function vr(e, t, n, r) {
    var i,
      o = pr(e, t),
      l = e.display.view;
    if (Rt && n != e.doc.first + e.doc.size) {
    ...
    (e.state.delayingBlurEvent = !0),
      setTimeout(function () {
        e.state.delayingBlurEvent &&
          ((e.state.delayingBlurEvent = !1), e.state.focused) &&
          Mr(e);
      }, 100);
  }
  function Tr(e, t) {
    e.state.delayingBlurEvent &&
      ...
      "nocursor" != e.options.readOnly &&
        (e.state.focused ||
          (O(e, "focus", e, t),
          (e.state.focused = !0),
          re(e.display.wrapper, "CodeMirror-focused"),
          e.curOp ||
  ...
  function Ar(e, t, n) {
    ...
    return (
      n &&
        ...
        (n = n.ensure.to.line),
        r < i
          ? (o = vt(t, rn(D(t, (i = r))) + e.wrapper.clientHeight))
          : Math.min(n, t.lastLine()) >= o &&
            ((i = vt(t, rn(D(t, n)) - e.wrapper.clientHeight)), (o = n))),
  ...
  function zr(e, t) {
    Math.abs(e.doc.scrollTop - t) < 2 ||
      (m || ti(e, { top: t }), Ir(e, t, !0), m && ti(e), qr(e, 100));
  }
  function Ir(e, t, n) {
    (t = Math.max(
      0,
  ...
  function Xr(n) {
    n.display.scrollbars &&
      (n.display.scrollbars.clear(), n.display.scrollbars.addClass) &&
      J(n.display.wrapper, n.display.scrollbars.addClass),
      (n.display.scrollbars = new jr[n.options.scrollbarStyle](
        function (e) {
          n.display.wrapper.insertBefore(e, n.display.scrollbarFiller),
            L(e, "mousedown", function () {
              n.state.focused &&
                setTimeout(function () {
      ...
      n.display.scrollbars.addClass &&
        re(n.display.wrapper, n.display.scrollbars.addClass);
  }
  var Yr = 0;
  function $r(e) {
    (e.curOp = {
            ...
            ((v = (function (e, t, n, r) {
              null == r && (r = 0),
                e.options.lineWrapping ||
                  t != n ||
                  ((n =
                    "before" == t.sticky ? H(t.line, t.ch + 1, "before") : t),
                  (t = t.ch
                    ? H(t.line, "before" == t.sticky ? t.ch - 1 : t.ch, "after")
                    : t));
              for (var i = 0; i < 5; i++) {
                var o,
                  l = !1,
                ...
                if (
                  (null != s.scrollTop &&
                    (zr(e, s.scrollTop), 1 < Math.abs(e.doc.scrollTop - a)) &&
                    (l = !0),
                  !(l =
                    null != s.scrollLeft &&
                    (Rr(e, s.scrollLeft), 1 < Math.abs(e.doc.scrollLeft - u))
                      ? !0
                      : l))
                )
                  break;
  ...
  function qr(e, t) {
    e.doc.highlightFrontier < e.display.viewTo &&
      e.state.highlight.set(t, ue(Zr, e));
  }
  function Zr(l) {
    var s,
      a,
        ...
        function (e) {
          if (a.line >= l.display.viewFrom) {
            for (
              ...
              i = t[o] != e.styles[o];
            i && u.push(a.line), (e.stateAfter = a.save());
          } else
            e.text.length <= l.options.maxHighlightLength && Dt(l, e.text, a),
              (e.stateAfter = a.line % 5 == 0 ? a.save() : null);
          if ((a.nextLine(), +new Date() > s))
            return qr(l, l.options.workDelay), !0;
        }
      ),
  ...
  function Jr(e, t) {
    ...
    var i = r.first + r.size,
      ...
      i =
        ((i = o),
        (o = l),
        0 == (s = (l = e).display).view.length ||
        i >= s.viewTo ||
        o <= s.viewFrom
          ? ((s.view = mn(l, i, o)), (s.viewFrom = i))
          : (s.viewFrom > i
              ? (s.view = mn(l, i, s.viewFrom).concat(s.view))
              : s.viewFrom < i && (s.view = s.view.slice(pr(l, i))),
            (s.viewFrom = i),
            s.viewTo < o
              ? (s.view = s.view.concat(mn(l, s.viewTo, o)))
              : s.viewTo > o && (s.view = s.view.slice(0, pr(l, o)))),
        (s.viewTo = o),
        (n.viewOffset = rn(D(e.doc, n.viewFrom))),
    ...
    var s,
      l =
        !(l = e).hasFocus() && (s = N(se(l))) && ne(l.display.lineDiv, s)
          ? ((s = { activeElt: s }),
            window.getSelection &&
              (o = ae(l).getSelection()).anchorNode &&
              o.extend &&
              ne(l.display.lineDiv, o.anchorNode) &&
              ((s.anchorNode = o.anchorNode),
              (s.anchorOffset = o.anchorOffset),
              (s.focusNode = o.focusNode),
              (s.focusOffset = o.focusOffset)),
            s)
          : null,
      a = (4 < i && (n.lineDiv.style.display = "none"), e),
      u = n.updateLineNumbers,
      c = t.dims,
      o = a.display,
      h = a.options.lineNumbers,
      d = o.lineDiv,
      f = d.firstChild;
    function p(e) {
      var t = e.nextSibling;
      return (
        x && C && a.display.currentWheelTarget == e
          ? (e.style.display = "none")
          : e.parentNode.removeChild(e),
        t
      );
    }
    for (var g = o.view, m = o.viewFrom, v = 0; v < g.length; v++) {
      var y = g[v];
      if (!y.hidden)
        if (y.node && y.node.parentNode == d) {
          for (; f != y.node; ) f = p(f);
          var b = h && null != u && u <= m && y.lineNumber;
          y.changes &&
            (-1 < S(y.changes, "gutter") && (b = !1), wn(a, y, m, c)),
            b &&
              (ee(y.lineNumber),
              y.lineNumber.appendChild(
                document.createTextNode(bt(a.options, m))
              )),
    ...
    return (
      ...
      (s = l) &&
        s.activeElt &&
        s.activeElt != N(s.activeElt.ownerDocument) &&
        (s.activeElt.focus(),
        !/^(INPUT|TEXTAREA)$/.test(s.activeElt.nodeName)) &&
        s.anchorNode &&
        ne(document.body, s.anchorNode) &&
        ne(document.body, s.focusNode) &&
        ((i = (o = s.activeElt.ownerDocument).defaultView.getSelection()),
        (o = o.createRange()).setEnd(s.anchorNode, s.anchorOffset),
        o.collapse(!1),
        i.removeAllRanges(),
        i.addRange(o),
        i.extend(s.focusNode, s.focusOffset)),
      ee(n.cursorDiv),
      ee(n.selectionDiv),
  ...
  function ui(e, t, n, r) {
    var i = this,
      o =
        ...
        (i.lineDiv = te("div", null, "CodeMirror-code")),
        (i.selectionDiv = M(
          "div",
          null,
          null,
        ...
        te("div", [i.lineSpace], "CodeMirror-lines"));
  ...
  function pi(e, t) {
    ...
    var n,
      ...
      l = hi,
      s =
        (0 === t.deltaMode && ((o = t.deltaX), (i = t.deltaY), (l = 1)),
        e.display),
      a = s.scroller,
    ...
    if ((o && u) || (i && c)) {
      if (i && C && x)
        e: for (var h = t.target, d = s.view; h != a; h = h.parentNode)
      ...
      !o || m || K || null == l
        ? (i &&
            null != l &&
            ((r = (u = e.doc.scrollTop) + s.wrapper.clientHeight),
            (n = i * l) < 0
              ? (u = Math.max(0, u + n - 50))
              : (r = Math.min(e.doc.height, r + n + 50)),
            ti(e, { top: u, bottom: r })),
          ci < 20 &&
            0 !== t.deltaMode &&
            (null == s.wheelStartX
        ...
        : (i && c && zr(e, Math.max(0, a.scrollTop + i * l)),
          Rr(e, Math.max(0, a.scrollLeft + o * l)),
          (i && !c) || T(t),
          (s.wheelStartX = null));
    }
  }
  w ? (hi = -0.53) : m ? (hi = 15) : U ? (hi = -0.7) : j && (hi = -1 / 3);
  var R = function (e, t) {
      (this.ranges = e), (this.primIndex = t);
    },
    B =
      ((R.prototype.primary = function () {
      ...
      (R.prototype.deepCopy = function () {
        for (var e = [], t = 0; t < this.ranges.length; t++)
          e[t] = new B(xt(this.ranges[t].anchor), xt(this.ranges[t].head));
        return new R(e, this.primIndex);
      }),
      (R.prototype.somethingSelected = function () {
      ...
      (R.prototype.contains = function (e, t) {
        ...
        for (var n = 0; n < this.ranges.length; n++) {
          var r = this.ranges[n];
          if (0 <= F(t, r.from()) && F(e, r.to()) <= 0) return n;
        }
        return -1;
      }),
      function (e, t) {
  ...
  function gi(e, t, n) {
    ...
    for (var i = 1; i < t.length; i++) {
      ...
      (r && !l.empty() ? 0 < a : 0 <= a) &&
        ...
        i <= n && --n,
        t.splice(--i, 2, new B(l ? o : a, l ? a : o)));
    }
    return new R(t, n);
  }
  function mi(e, t) {
    return new R([new B(e, t || e)], 0);
  }
  function vi(e) {
    return e.text
      ? H(
  ...
  function yi(e, t) {
    ...
    return F(e, t.from) < 0
      ...
      : F(e, t.to) <= 0
      ? vi(t)
      : ((n = e.line + t.text.length - (t.to.line - t.from.line) - 1),
        (r = e.ch),
        e.line == t.to.line && (r += vi(t).ch - t.to.ch),
        H(n, r));
  }
  function bi(e, t) {
    for (var n = [], r = 0; r < e.sel.ranges.length; r++) {
      var i = e.sel.ranges[r];
      n.push(new B(yi(i.anchor, t), yi(i.head, t)));
    }
    return gi(e.cm, n, e.sel.primIndex);
  }
  function wi(e, t, n) {
    return e.line == t.line
      ? H(n.line, e.ch - t.ch + n.ch)
      : H(n.line + (e.line - t.line), e.ch);
  }
  function xi(e) {
      ...
      if (t.linked)
        for (var i = 0; i < t.linked.length; ++i) {
          var o,
            l = t.linked[i];
          l.doc != n &&
            ((o = r && l.sharedHist), !a || o) &&
            (s(l.doc, o), e(l.doc, t, o));
        }
    })(e, null, !0);
  }
  function Ti(e, t) {
  ...
  function Mi(e) {
    ("rtl" == e.doc.direction ? re : J)(e.display.lineDiv, "CodeMirror-rtl");
  }
  function Ni(e) {
    (this.done = []),
      (this.undone = []),
  ...
  function Di(e, t, n, r) {
    ...
    if (
      ...
      (i = I(o.changes)),
        0 == F(t.from, t.to) && 0 == F(t.from, i.to)
          ? (i.to = vi(t))
  ...
  function zi(e, t, n) {
    for (var r = [], i = 0; i < e.length; ++i) {
      var o = e[i];
      if (o.ranges) r.push(n ? R.prototype.deepCopy.call(o) : o);
      else {
        var l = o.changes,
          s = [];
        r.push({ changes: s });
  ...
  function Ri(e, t, n, r, i) {
    null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
      G(e, new R([Ii(e.sel.primary(), t, n, i)], 0), r);
  }
  function Bi(e, t, n) {
    for (
    ...
    G(e, gi(e.cm, r, e.sel.primIndex), n);
  }
  function Gi(e, t, n, r) {
    var i = e.sel.ranges.slice(0);
    (i[t] = n), G(e, gi(e.cm, i, e.sel.primIndex), r);
  }
  function Ui(e, t, n, r) {
    G(e, mi(t, n), r);
  }
  function Vi(e, t, n) {
    var r = e.history.done,
      i = I(r);
    i && i.ranges ? Ki(e, (r[r.length - 1] = t), n) : G(e, t, n);
  }
  function G(e, t, n) {
    ...
    (je(e, "beforeSelectionChange") ||
      ...
      (o = {
        ...
        update: function (e) {
          this.ranges = [];
          for (var t = 0; t < e.length; t++)
            this.ranges[t] = new B(P(r, e[t].anchor), P(r, e[t].head));
        },
        origin: o && o.origin,
      }),
  ...
  function Yi(e, t, n, r) {
    for (var i, o = 0; o < t.ranges.length; o++) {
      ...
      (!i && a == l.anchor && s == l.head) ||
        ((i = i || t.ranges.slice(0, o))[o] = new B(a, s));
    }
  ...
  function _i(e, t, n, r, i) {
    (r = r || 1),
      (i =
        ...
        $i(e, t, n, -r, i) ||
        (!i && $i(e, t, n, -r, !0)));
    return i || ((e.cantEdit = !0), H(e.first, 0));
  }
  function qi(e, t, n, r) {
    return n < 0 && 0 == t.ch
      ? t.line > e.first
        ? P(e, H(t.line - 1))
        : null
      : 0 < n && t.ch == (r || D(e, t.line)).text.length
  ...
  function Zi(e) {
    e.setSelection(H(e.firstLine(), 0), H(e.lastLine()), ge);
  }
  function Qi(i, e, t) {
    var o = {
      canceled: !1,
  ...
  function Ji(e, t, n) {
    if (e.cm) {
      if (!e.cm.curOp) return z(e.cm, Ji)(e, t, n);
            ...
            (e.iter(t.line, n.line + 1, function (e) {
              if (e.markedSpans)
                for (var t = 0; t < e.markedSpans.length; ++t) {
                  ...
                  !n.readOnly || (r && -1 != S(r, n)) || (r = r || []).push(n);
                }
            }),
            !r)
          )
  ...
  function eo(e, n) {
    var t, r;
    (1 == n.text.length && "" == n.text[0] && 0 == F(n.from, n.to)) ||
      ((t = bi(e, n)),
      Di(e, n, t, e.cm ? e.cm.curOp.id : NaN),
      ro(e, n, t, Ut(e, n)),
      (r = []),
      ki(e, function (e, t) {
        t || -1 != S(r, e.history) || (so(e.history, n), r.push(e.history)),
          ro(e, n, null, Ut(e, n));
      }));
  }
  function to(i, o, e) {
  ...
  function no(e, t) {
    if (
      ...
      E(e.cm, e.first, e.first - t, t);
      for (var n = e.cm.display, r = n.viewFrom; r < n.viewTo; r++)
        gr(e.cm, r, "gutter");
    }
  }
  function ro(e, t, n, r) {
    if (e.cm && !e.cm.curOp) return z(e.cm, ro)(e, t, n, r);
      ...
      if (
        ...
        qr(i, 400),
          ...
          ((s = je(i, "change")) || d) &&
            ...
            s && b(i, "change", i, l),
            d) &&
            (i.curOp.changeObjs || (i.curOp.changeObjs = [])).push(l),
          (i.display.selForContextMenu = null);
      } else Li(e, t, r);
      Ki(e, n, ge),
        e.cantEdit && _i(e, H(e.firstLine(), 0)) && (e.cantEdit = !1);
    }
  }
  function io(e, t, n, r, i) {
    var o;
    F((r = r || n), n) < 0 && ((n = (o = [r, n])[0]), (r = o[1])),
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      if (o.ranges) {
        ...
        for (var a = 0; a < o.changes.length; ++a) {
          var u = o.changes[a];
          if (n < u.from.line)
            (u.from = H(u.from.line + r, u.from.ch)),
  ...
  function ao(e, t, n, r) {
    var i = t,
      o = t;
    return (
      "number" == typeof t ? (o = D(e, Lt(e, t))) : (i = W(t)),
  ...
  (ho.prototype.clear = function () {
    ...
    (ho.prototype.changed = function () {
      ...
      i &&
        (nn(this.doc, r) || mt(r, r.height + i), n) &&
        h(n, function () {
          (n.curOp.forceUpdate = !0),
            fo(n, r, i),
            b(n, "lineWidgetChanged", n, e, W(r));
        });
    }),
    Xe(ho);
  function po(e, t) {
  ...
  function mo(r, i, o, e, t) {
    ...
    var n, l, s, a, u, c, h;
    if (r.cm && !r.cm.curOp) return z(r.cm, mo)(r, i, o, e, t);
    var d = new po(r, t),
      f = F(i, o);
    if ((e && ce(e, d, !1), !(0 < f || (0 == f && !1 !== d.clearWhenEmpty)))) {
      if (
        (d.replacedWith &&
          ((d.collapsed = !0),
          (d.widgetNode = te("span", [d.replacedWith], "CodeMirror-widget")),
          e.handleMouseEvents ||
      ...
      if (
        ...
        d.clearOnEnter &&
          L(d, "beforeCursorEnter", function () {
            return d.clear();
          }),
        d.readOnly &&
          ((It = !0), r.history.done.length || r.history.undone.length) &&
          r.clearHistory(),
  ...
  (po.prototype.clear = function () {
    if (!this.explicitlyCleared) {
      for (
        ...
        t && !this.collapsed
          ? gr(t, W(l), "text")
          : t && (null != s.to && (i = W(l)), null != s.from) && (r = W(l)),
      ...
      null != r && t && this.collapsed && E(t, r, i + 1),
        (this.lines.length = 0),
        (this.explicitlyCleared = !0),
        this.atomic &&
          this.doc.cantEdit &&
          ((this.doc.cantEdit = !1), t) &&
          Xi(t.doc),
    ...
    (po.prototype.find = function (e, t) {
      ...
      for (var i = 0; i < this.lines.length; ++i) {
        ...
        if (null != l.from && ((n = H(t ? o : W(o), l.from)), -1 == e))
          return n;
        if (null != l.to && ((r = H(t ? o : W(o), l.to)), 1 == e)) return r;
      }
      ...
      r &&
        ...
        h(o, function () {
          ...
          t && (Vn(t), (o.curOp.selectionChanged = o.curOp.forceUpdate = !0)),
            ...
            !nn(i.doc, e) &&
              null != i.height &&
              ((t = i.height), (i.height = null), (t = Mn(i) - t)) &&
              mt(e, e.height + t),
    ...
    for (var e = 0; e < o.length; e++)
      !(function (e) {
        ...
        for (var r = 0; r < t.markers.length; r++) {
          var i = t.markers[r];
          -1 == S(n, i.doc) && ((i.parent = null), t.markers.splice(r--, 1));
        }
      })(e);
  }
  ...
  function f(e, t, n, r, i) {
    ...
    null == n && (n = 0),
      ...
      (n = H((this.modeFrontier = this.highlightFrontier = n), 0)),
      (this.sel = mi(n)),
    ...
    xo =
      (((f.prototype = Se(co.prototype, {
        ...
        replaceRange: function (e, t, n, r) {
          io(this, e, (t = P(this, t)), (n = n ? P(this, n) : t), r);
        },
        getRange: function (e, t, n) {
          e = pt(this, P(this, e), P(this, t));
          return !1 === n
            ? e
            : "" === n
            ? e.join("")
        ...
        getLineHandle: function (e) {
          if (yt(this, e)) return D(this, e);
        },
        getLineNumber: W,
        getLineHandleVisualStart: function (e) {
          return Jt((e = "number" == typeof e ? D(this, e) : e));
        },
        lineCount: function () {
          return this.size;
        },
        ...
        setCursor: r(function (e, t, n) {
          Ui(this, P(this, "number" == typeof e ? H(e, t || 0) : e), null, n);
        }),
        setSelection: r(function (e, t, n) {
          Ui(this, P(this, e), P(this, t || e), n);
        }),
        extendSelection: r(function (e, t, n) {
          Ri(this, P(this, e), t && P(this, t), n);
        }),
        ...
        setSelections: r(function (e, t, n) {
          if (e.length) {
            ...
            null == t && (t = Math.min(e.length - 1, this.sel.primIndex)),
              G(this, gi(this.cm, r, t), n);
          }
        }),
        addSelection: r(function (e, t, n) {
          var r = this.sel.ranges.slice(0);
          r.push(new B(P(this, e), P(this, t || e))),
            G(this, gi(this.cm, r, r.length - 1), n);
        }),
                ...
                (function (e, t, n) {
                  for (
                    ...
                    var l = t[o],
                      ...
                      i = a;
                    "around" == n
                      ? ((l = F((l = e.sel.ranges[o]).head, l.anchor) < 0),
                        (r[o] = new B(l ? a : s, l ? s : a)))
                      : (r[o] = new B(s, s));
                  }
                  return new R(r, e.sel.primIndex);
                })(this, r, t),
              s = r.length - 1;
            0 <= s;
            s--
          ...
          return ao(this, e, "gutter" == n ? "gutter" : "class", function (e) {
            var t =
              "text" == n
                ...
                : "wrapClass";
            if (e[t]) {
              if (Q(r).test(e[t])) return;
              e[t] += " " + r;
            } else e[t] = r;
            return 1;
          });
        }),
        removeLineClass: r(function (e, o, l) {
        ...
        addLineWidget: r(function (e, t, n) {
          return (
            ...
            o && b(o, "lineWidgetAdded", o, i, "number" == typeof e ? e : W(e)),
            i
          );
          var r, i, o;
        }),
        ...
        markText: function (e, t, n) {
          return mo(this, P(this, e), P(this, t), n, (n && n.type) || "range");
        },
        setBookmark: function (e, t) {
          ...
          return mo(this, (e = P(this, e)), e, t, "bookmark");
        },
        findMarksAt: function (e) {
          var t = [],
            n = D(this, (e = P(this, e)).line).markedSpans;
          if (n)
            for (var r = 0; r < n.length; ++r) {
              var i = n[r];
  ...
  function Co(e) {
    ...
    if ((So(r), !A(r, e) && !Nn(r.display, e))) {
      ...
      if (t && !r.isReadOnly())
        if (n && n.length && window.FileReader && window.File)
          for (
              ...
              s = function () {
                ++l == i &&
                  z(r, function () {
                    ...
                    Ji(r.doc, e), Vi(r.doc, mi(P(r.doc, t), P(r.doc, vi(e))));
                  })();
              },
              a = 0;
            a < n.length;
            ...
            !(function (e, t) {
              ...
              -1 == S(r.options.allowDropFileTypes, e.type)
                ? s()
        ...
        else if (r.state.draggingText && -1 < r.doc.sel.contains(t))
  ...
  function zo(e, t, n) {
    ...
    return (
      ...
      (q ? t.metaKey : t.ctrlKey) && "Ctrl" != r && (e = "Ctrl-" + e),
      (q ? t.ctrlKey : t.metaKey) && "Mod" != r && (e = "Cmd-" + e),
  ...
  function Bo(t, e) {
    for (var n = t.doc.sel.ranges, r = [], i = 0; i < n.length; i++) {
      for (var o = e(n[i]); r.length && F(o.from, I(r).to) <= 0; ) {
        var l = r.pop();
  ...
  function Uo(e, t, n) {
    e = Go(e, t.ch, n);
    return null == e ? null : new H(t.line, e, n < 0 ? "after" : "before");
  }
  function Vo(e, t, n, r, i) {
    ...
    return new H(r, i < 0 ? n.text.length : 0, i < 0 ? "before" : "after");
  }
  function Ko(t, n, s, e) {
    ...
    if (
      ...
      return Uo(n, s, e);
    function u(e, t) {
      return Go(n, e instanceof H ? e.ch : e, t);
    }
    function o(e) {
    ...
    if ("rtl" == t.doc.direction || 1 == i.level) {
      ...
      if (
        ...
        return new H(s.line, d, h ? "before" : "after");
    }
    function f(e, t, n) {
      for (
        var r = function (e, t) {
          return t
            ? new H(s.line, u(e, 1), "before")
            : new H(s.line, e, "after");
        };
        0 <= e && e < a.length;
        e += t
      ) {
  ...
  var jo = {
    ...
    killLine: function (n) {
      return Bo(n, function (e) {
        var t;
        return e.empty()
          ? ((t = D(n.doc, e.head.line).text.length),
            e.head.ch == t && e.head.line < n.lastLine()
              ? { from: e.head, to: H(e.head.line + 1, 0) }
              : { from: e.head, to: H(e.head.line, t) })
          : { from: e.from(), to: e.to() };
      });
    },
    ...
    transposeChars: function (l) {
      return h(l, function () {
        for (
          ...
          r[o].empty() &&
            ((e = r[o].head),
            (t = D(l.doc, e.line).text) &&
              (0 < (e = e.ch == t.length ? new H(e.line, e.ch - 1) : e).ch
                ? ((e = new H(e.line, e.ch + 1)),
                  l.replaceRange(
                ...
                : e.line > l.doc.first &&
                  (n = D(l.doc, e.line - 1).text) &&
                  ((e = new H(e.line, 1)),
                  l.replaceRange(
                    t.charAt(0) +
                      l.doc.lineSeparator() +
                      n.charAt(n.length - 1),
                    H(e.line - 1, n.length - 1),
                    e,
                    "+transpose"
                  ))),
            i.push(new B(e, e)));
  ...
  function el(e) {
    ...
    (e.target && e.target != i.display.input.getField()) ||
      ...
      (re((r = i.display.lineDiv), "CodeMirror-crosshair"),
      L(document, "keyup", o),
      L(document, "mouseover", o));
  }
  function tl(e) {
  ...
  function nl(e) {
    ...
    (e.target && e.target != i.display.input.getField()) ||
      ...
      K && n == Jo
        ? ((Jo = null), T(e))
        : (K && (!e.which || e.which < 10) && Qo(i, e)) ||
          "\b" == (n = String.fromCharCode(null == t ? n : t)) ||
          qo((r = i), "'" + n + "'", e, function (e) {
            return $o(r, e, !0);
          }) ||
          i.display.input.onKeyPress(e));
  }
  function rl(e, t, n) {
          ...
          (1 == n
            ? t
              ? ((i = c),
                ...
                (l = r),
                (s = e),
                w ? setTimeout(ue(Lr, i), 0) : (i.curOp.focus = N(se(i))),
                (a = (function (e, t, n) {
                    ...
                    r = r ? r(e, t, n) : {};
                  {
                    var i;
                    null == r.unit &&
                      ((i = _ ? n.shiftKey && n.metaKey : n.altKey),
                      (r.unit = i
                        ? "rectangle"
                        : "single" == t
                        ? "char"
                ...
                (i.options.dragDrop &&
                  ...
                  "single" == l &&
                  -1 < (l = u.contains(o)) &&
                  (F((l = u.ranges[l]).from(), o) < 0 || 0 < o.xRel) &&
                  (0 < F(l.to(), o) || o.xRel < 0)
                  ? function (t, n, r, i) {
                      var o = t.display,
                        l = !1,
                      ...
                      ((t.state.draggingText = s).copy = !i.moveOnDrag),
                        L(o.wrapper.ownerDocument, "mouseup", s),
                        L(o.wrapper.ownerDocument, "mousemove", a),
                        L(o.scroller, "dragstart", u),
                        L(o.scroller, "drop", s),
                  ...
                  : function (d, e, f, p) {
                        ...
                        if (0 != F(b, e))
                          if (((b = e), "rectangle" == p.unit)) {
                            for (
                              var t = [],
                                n = d.options.tabSize,
                                r = he(D(g, f.line).text, f.ch, n),
                                i = he(D(g, e.line).text, e.ch, n),
                                o = Math.min(r, i),
                                l = Math.max(r, i),
                              ...
                              var u = D(g, s).text,
                                c = ye(u, o, n);
                              o == l
                                ? t.push(new B(H(s, c), H(s, c)))
                                : u.length > c &&
                                  t.push(new B(H(s, c), H(s, ye(u, l, n))));
                            }
                            t.length || t.push(new B(f, f)),
                              G(g, gi(d, y.ranges.slice(0, v).concat(t), v), {
                                origin: "*mouse",
                                scroll: !1,
                              }),
                              d.scrollIntoView(e);
                      ...
                      (d.state.selectingText = i),
                        L(l.wrapper.ownerDocument, "mousemove", r),
                        L(l.wrapper.ownerDocument, "mouseup", i);
                    })(i, s, o, a))
              : qe(e) == h.scroller && T(e)
            : 2 == n
            ? (t && Ri(c.doc, t),
            ...
            : 3 == n && (Z ? c.display.input.onContextMenu(e) : kr(c))));
  }
  function sl(e, t, n) {
    return "char" == n
      ? new B(t, t)
      ...
      ? e.findWordAt(t)
      : "line" == n
      ? new B(H(t.line, 0), P(e.doc, H(t.line + 1, 0)))
      : ((n = n(e, t)), new B(n.from, n.to));
  }
  function al(e, t, n, r) {
    var i, o;
  ...
  rl.prototype.compare = function (e, t, n) {
    return this.time + 400 > e && 0 == F(t, this.pos) && n == this.button;
  };
  var dl = {
      toString: function () {
  ...
  function gl(e, t, n) {
    !t != !(n && n != dl) &&
      ...
      (t = t ? L : k)(e.display.scroller, "dragstart", n.start),
  ...
  function ml(e) {
    e.options.lineWrapping
      ? (re(e.display.wrapper, "CodeMirror-wrap"),
        (e.display.sizer.style.minWidth = ""),
        (e.display.sizerWidth = null))
      : (J(e.display.wrapper, "CodeMirror-wrap"), ln(e)),
      dr(e),
      E(e),
      jn(e),
      setTimeout(function () {
  ...
  function p(e, t) {
    ...
    (this.options = t = t ? ce(t) : {}), ce(fl, t, !1);
    var r,
      i = t.value,
      o =
        ("string" == typeof i
        ...
        w && v < 11
          ? z(l, function (e) {
              ...
              A(l, e) ||
                ...
                ul(l, e) ||
                Nn(l.display, e) ||
                (T(e), (e = l.findWordAt(t)), Ri(l.doc, e.anchor, e.head));
            })
          : function (e) {
              return A(l, e) || T(e);
            }
      ),
      L(s.scroller, "contextmenu", function (e) {
        return cl(l, e);
      }),
      L(s.input.getField(), "contextmenu", function (e) {
    ...
    function h(e, t) {
      ...
      return (
        null == t.left ||
        400 < (n = t.left - e.left) * n + (n = t.top - e.top) * n
      );
    }
    L(s.scroller, "touchstart", function (e) {
      var t;
      A(l, e) ||
        (function (e) {
      ...
      L(s.scroller, "touchmove", function () {
        s.activeTouch && (s.activeTouch.moved = !0);
      }),
      L(s.scroller, "touchend", function (e) {
        var t,
          n = s.activeTouch;
        n &&
          !Nn(s, e) &&
          ...
          (n =
            !n.prev || h(n, n.prev)
              ...
              ? l.findWordAt(t)
              : new B(H(t.line, 0), P(l.doc, H(t.line + 1, 0)))),
          l.setSelection(n.anchor, n.head),
          l.focus(),
          T(e)),
          c();
      }),
      L(s.scroller, "touchcancel", c),
      L(s.scroller, "scroll", function () {
        s.scroller.clientHeight &&
          (zr(l, s.scroller.scrollTop),
          Rr(l, s.scroller.scrollLeft, !0),
          O(l, "scroll", l));
      }),
      L(s.scroller, "mousewheel", function (e) {
        return pi(l, e);
      }),
      L(s.scroller, "DOMMouseScroll", function (e) {
        return pi(l, e);
      }),
      L(s.wrapper, "scroll", function () {
    ...
    o = s.input.getField();
    for (r in (L(o, "keyup", function (e) {
      return tl.call(l, e);
    }),
    L(o, "keydown", z(l, el)),
    L(o, "keypress", z(l, nl)),
    L(o, "focus", function (e) {
      return Tr(l, e);
    }),
    L(o, "blur", function (e) {
      return Mr(l, e);
  ...
  function yl(e, t, n, r) {
    ...
    "prev" == n
      ? (c = t > o.first ? he(D(o, t - 1).text, null, l) : 0)
      : "add" == n
    ...
    if ((d < c && (h += we(c - d)), h != u))
      return (
        io(o, h, H(t, 0), H(t, u.length), "+input"), !(s.stateAfter = null)
      );
        ...
        f =
          (f.empty() &&
            (n && 0 < n
              ...
              ? (g = H(
                  g.line,
                  Math.min(D(o, g.line).text.length, g.ch + I(a).length)
                ))
              : s &&
                bl &&
                bl.lineWise &&
  ...
  function Tl() {
    ...
    return (
      ...
      d && (e.style.border = "1px solid black"),
      t
    );
  }
    ...
    function u(e) {
      ...
      if (
        ...
        if (
          ...
          (e = r.line + a) < n.first ||
          e >= n.first + n.size ||
          ((r = new H(e, r.ch, r.sticky)), !(s = D(n, e)))
        )
          return;
    ...
    for (
      "page" == r
        ? ((i = Math.min(
            ...
            ae(e).innerHeight || s(e).documentElement.clientHeight
          )),
  ...
  function Ol(e, t) {
    ...
    return !i || i.hidden
      ? null
      : ((n = Pn(i, (i = D(e.doc, t.line)), t.line)),
        (r = "left"),
        (i = Ge(i, e.doc.direction)) &&
          (r = He(i, t.ch) % 2 ? "right" : "left"),
        ((e = Un(n.map, t.ch, r)).offset =
          "right" == e.collapse ? e.end : e.start),
        e);
  }
  function Al(e, t) {
    return t && (e.bad = !0), e;
  ...
  function Dl(e, t, n) {
    ...
    if (t == e.display.lineDiv) {
      if (!(r = e.display.lineDiv.childNodes[n]))
        return Al(e.clipPos(H(e.display.viewTo - 1)), !0);
      (t = null), (n = 0);
    } else
    ...
    for (var i = 0; i < e.display.view.length; i++) {
      ...
      if (o.node == r) {
        var u = o,
          ...
          s = u.text.firstChild,
          a = !1;
        if (!o || !ne(s, o)) return Al(H(W(u.line), 0), !0);
        if (o == s)
          if (((a = !0), (o = s.childNodes[l]), (l = 0), !o))
            return Al(
              H(W((c = u.rest ? I(u.rest) : u.line)), c.text.length),
              a
            );
        ...
        function p(e, t, n) {
          for (var r = -1; r < (f ? f.length : 0); r++)
            for (var i = r < 0 ? d.map : f[r], o = 0; o < i.length; o += 3) {
              ...
              if (a == e || a == t)
                return (
                  (l = W(r < 0 ? u.line : u.rest[r])),
                  (s = i[o] + n),
                  H(l, (s = n < 0 || a != e ? i[o + (n ? 1 : 0)] : s))
                );
            }
        }
        var g = p(c, h, l);
        ...
        for (
          ...
          if ((g = p(m, m.firstChild, 0))) return Al(H(g.line, g.ch - v), a);
          v += m.textContent.length;
        }
        for (var y = h.previousSibling, b = l; y; y = y.previousSibling) {
          if ((g = p(y, y.firstChild, -1))) return Al(H(g.line, g.ch + b), a);
  ...
  (i.prototype.init = function (e) {
    ...
    (s.contentEditable = !0),
      ...
      L(s, "compositionstart", function (e) {
        t.composing = { data: e.data, done: !1 };
      }),
      L(s, "compositionupdate", function (e) {
        t.composing || (t.composing = { data: e.data, done: !1 });
      }),
      L(s, "compositionend", function (e) {
        t.composing &&
          (e.data != t.composing.data && t.readFromDOMSoon(),
          (t.composing.done = !0));
      }),
      L(s, "touchstart", function () {
    ...
    (i.prototype.showSelection = function (e, t) {
      e &&
    ...
    (i.prototype.showPrimarySelection = function () {
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            try {
              l = oe(o.node, o.offset, r.offset, r.node);
            } catch (e) {}
            l &&
              ((!m &&
                t.state.focused &&
                (e.collapse(o.node, o.offset), l.collapsed)) ||
    ...
    (i.prototype.startGracePeriod = function () {
      var e = this;
    ...
    (i.prototype.showMultipleSelections = function (e) {
      y(this.cm.display.cursorDiv, e.cursors),
        y(this.cm.display.selectionDiv, e.selection);
    }),
    (i.prototype.rememberSelection = function () {
      var e = this.getSelection();
    ...
    (i.prototype.selectionInEditor = function () {
      var e = this.getSelection();
      return (
        !!e.rangeCount &&
        ((e = e.getRangeAt(0).commonAncestorContainer), ne(this.div, e))
      );
    }),
    ...
    (i.prototype.pollSelection = function () {
      var e, t, n, r;
      null == this.readDOMTimeout &&
        ...
        (function (e) {
          ...
          : this.composing ||
            (this.rememberSelection(),
            (n = Dl(t, e.anchorNode, e.anchorOffset)),
    ...
    (i.prototype.pollContent = function () {
      null != this.readDOMTimeout &&
      ...
      if (
        (0 == i.ch &&
          i.line > t.firstLine() &&
          (i = H(i.line - 1, D(t.doc, i.line - 1).length)),
        r.ch == D(t.doc, r.line).text.length &&
          r.line < t.lastLine() &&
          (r = H(r.line + 1, 0)),
      ...
      var o,
        l =
          i.line == n.viewFrom || 0 == (l = pr(t, i.line))
            ? ((e = W(n.view[0].line)), n.view[0].node)
            : ((e = W(n.view[l].line)), n.view[l - 1].node.nextSibling),
        r = pr(t, r.line),
        n =
          r == n.view.length - 1
            ? ((o = n.viewTo - 1), n.lineDiv.lastChild)
            : ((o = W(n.view[r + 1].line) - 1),
      ...
      for (
        var s = t.doc.splitLines(
          ...
          a = pt(t.doc, H(e, 0), H(o, D(t.doc, o).text.length));
      ...
      (r = H(e, u)), (l = H(o, a.length ? I(a).length - c : 0));
      return 1 < s.length || s[0] || F(r, l)
    ...
    (i.prototype.forceCompositionEnd = function () {
      this.composing &&
    ...
    (i.prototype.readFromDOMSoon = function () {
      var e = this;
      null == this.readDOMTimeout &&
    ...
    (i.prototype.updateFromDOM = function () {
      var e = this;
    ...
    (i.prototype.setUneditable = function (e) {
      e.contentEditable = "false";
    }),
    (i.prototype.onKeyPress = function (e) {
      0 == e.charCode ||
        this.composing ||
    ...
    (i.prototype.onContextMenu = function () {}),
    (i.prototype.resetPosition = function () {}),
    (i.prototype.needsContentAttribute = !0);
  function o(e) {
    (this.cm = e),
      (this.prevInput = ""),
      (this.pollingFast = !1),
  ...
  (o.prototype.init = function (n) {
    ...
    n.wrapper.insertBefore(this.wrapper, n.wrapper.firstChild),
      ...
      L(o, "cut", t),
      L(o, "copy", t),
      L(n.scroller, "paste", function (e) {
        var t;
        Nn(n, e) ||
          A(i, e) ||
          (o.dispatchEvent
            ? (((t = new Event("paste")).clipboardData = e.clipboardData),
              o.dispatchEvent(t))
            : ((i.state.pasteIncoming = +new Date()), r.focus()));
      }),
      L(n.lineSpace, "selectstart", function (e) {
        Nn(n, e) || T(e);
      }),
      L(o, "compositionstart", function () {
    ...
    (o.prototype.screenReaderLabelChanged = function (e) {
      e
    ...
    (o.prototype.showSelection = function (e) {
      ...
      this.contextMenuPending ||
        ...
        t.somethingSelected()
          ? ((this.prevInput = ""),
            ...
            t.state.focused && le(this.textarea),
    ...
    (o.prototype.focus = function () {
      if (
        "nocursor" != this.cm.options.readOnly &&
        (!$ || N(this.textarea.ownerDocument) != this.textarea)
      )
        try {
          this.textarea.focus();
        } catch (e) {}
    ...
    (o.prototype.onContextMenu = function (e) {
      ...
      u &&
        ...
        Z
          ? (_e(e),
            (i = function () {
              k(window, "mouseup", i), setTimeout(d, 20);
            }),
            L(window, "mouseup", i))
          : setTimeout(d, 50));
    }),
    (o.prototype.readOnlyChanged = function (e) {
      e || this.reset(),
        (this.textarea.disabled = "nocursor" == e),
        (this.textarea.readOnly = !!e);
    }),
    (o.prototype.setUneditable = function () {}),
    (o.prototype.needsContentAttribute = !1),
    ...
    l("lineSeparator", null, function (e, r) {
      if ((e.doc.lineSep = r)) {
        var i = [],
          o = e.doc.first;
        e.doc.iter(function (e) {
          for (var t = 0; ; ) {
            ...
            if (-1 == n) break;
            (t = n + r.length), i.push(H(o, n));
          }
          o++;
        });
        for (var t = i.length - 1; 0 <= t; t--)
          io(e.doc, r, i[t], H(i[t].line, i[t].ch + r.length));
      }
    }),
    l(
      "specialChars",
    ...
    l("cursorHeight", 1, br, !0),
    l("singleCursorHeightPerLine", !0, br, !0),
    l("workTime", 100),
    l("workDelay", 100),
    l("flattenSpans", !0, Ci, !0),
    l("addModeClass", !1, Ci, !0),
    l("pollInterval", 100),
    l("undoDepth", 200, function (e, t) {
    ...
    l("maxHighlightLength", 1e4, Ci, !0),
    l("moveInputWithCursor", !0, function (e, t) {
      t || e.display.input.resetPosition();
    }),
    l("tabindex", null, function (e, t) {
    ...
    (Fl.prototype = {
      ...
      setOption: function (e, t) {
        ...
        (n[e] == t && "mode" != e) ||
          ((n[e] = t),
          Pl.hasOwnProperty(e) && z(this, Pl[e])(this, t, r),
      ...
      addOverlay: n(function (e, t) {
        ...
        for (
          ...
          o++;
        r.splice(o, 0, n), this.state.modeGen++, E(this);
      }),
      removeOverlay: n(function (e) {
        for (var t = this.state.overlays, n = 0; n < t.length; ++n) {
          var r = t[n].modeSpec;
          if (r == e || ("string" == typeof e && r.name == e))
            return t.splice(n, 1), this.state.modeGen++, void E(this);
        }
      }),
      indentLine: n(function (e, t, n) {
        "string" != typeof t &&
          "number" != typeof t &&
          (t =
            null == t
        ...
        for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
          ...
          if (i.empty())
            ...
            0 == o.ch &&
              t.length == i.length &&
              0 < i[r].from().ch &&
              Gi(this.doc, r, new B(o, i[r].to()), ge);
          }
        }
      }),
      ...
      getLineTokens: function (e, t) {
        return Pt(this, H(e), t, !0);
      },
      getTokenTypeAt: function (e) {
        e = P(this.doc, e);
        var t,
          n = Ot(this, D(this.doc, e.line)),
          r = 0,
          i = (n.length - 1) / 2,
          o = e.ch;
        if (0 == o) t = n[2];
      ...
      getHelpers: function (e, t) {
        ...
        if (El.hasOwnProperty(t)) {
          ...
          for (var s = 0; s < r._global.length; s++) {
            var a = r._global[s];
            a.pred(i, this) && -1 == S(n, a.val) && n.push(a.val);
          }
        }
        return n;
      },
      ...
      charCoords: function (e, t) {
        return Zn(this, P(this.doc, e), t || "page");
      },
      ...
      triggerOnKeyDown: n(el),
      triggerOnKeyPress: n(nl),
      triggerOnKeyUp: tl,
      triggerOnMouseDown: n(ll),
      execCommand: function (e) {
        if (jo.hasOwnProperty(e)) return jo[e].call(null, this);
      },
      triggerElectric: n(function (e) {
        Sl(this, e);
      }),
      ...
      findWordAt: function (e) {
        ...
        return new B(H(e.line, n), H(e.line, r));
      },
      toggleOverwrite: function (e) {
        (null != e && e == this.state.overwrite) ||
          (((this.state.overwrite = !this.state.overwrite) ? re : J)(
      ...
      hasFocus: function () {
        return this.display.input.getField() == N(se(this));
      },
      isReadOnly: function () {
        return !(!this.options.readOnly && !this.doc.cantEdit);
      },
      scrollTo: n(function (e, t) {
        Fr(this, e, t);
      }),
  ...
  return (
    Xe(f),
    (p.inputStyles = { textarea: o, contenteditable: i }),
    ...
    (p.fromTextArea = function (t, n) {
      ...
      if (
        ...
        t.form && (L(t.form, "submit", r), !n.leaveSubmitMethodAlone))
      ) {
        var i = t.form,
          o = i.submit;
        try {
    ...
    (t.isModifierKey = Eo),
    (t.lookupKey = Po),
    (t.normalizeKeyMap = Fo),
    (t.StringStream = g),
    (t.SharedTextMarker = vo),
    (t.TextMarker = po),
    (t.LineWidget = ho),
    (t.e_preventDefault = T),
    (t.e_stopPropagation = Ye),
    (t.e_stop = _e),
    (t.addClass = re),
    (t.contains = ne),
    (t.rmClass = J),
