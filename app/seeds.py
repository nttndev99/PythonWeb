    ...
    try:
        if not has_users and not has_posts and not has_categories:
            ...
            category1 = Categories(
                ...
                logo_url='programming-logo.png',
                author=user
            )            
            category2 = Categories(
                id=2,
                category_name='Website Programming',
            ...
            category3 = Categories(
                ...
                logo_url='cloud-database.png',
                author=user     
            )     
            category4 = Categories(
                id=4,
                category_name='Data Science',
                logo_url='data-science.png',
                author=user     
            )              
            ...
            category6 = Categories(
                id=6,
                category_name='Design Principles',
                logo_url='prototype.png',
                author=user     
            )            
            post1 = Posts(
                title='Python',
